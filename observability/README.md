...
- `cloudwatch-dashboard.json` — CloudWatch dashboard template.
- `logs-insights-queries.md` — copy-ready Logs Insights queries.
- `screenshot-checklist.md` — required screenshot checklist and naming.
